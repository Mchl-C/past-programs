...
def login_screen():
    pil = ""
    while(pil != 0):
        print("Selamat datang di Perpustakaan Ricky!")
        ...
        if(pil == 1):
            ...
            if(username in members):
                ...
                print("Nama atau Password tidak terdaftar!")
        else:
            if(pil != 0):
...
def admin_screen(identity):
    ...
    ''')
            ...
            print("Pilihan hanya dari 0-3!")
            admin_screen(identity)
            identity = None
            run = True
            ...
            while True:
                for i in range(1,len(members)+1):
                    ...
                    if(n >= 1 and n <= len(members)):
                        print("Password : ",members[list(members)[n - 1]])
                else:
                    break
                print()
        elif(choice == 0):
            identity = "Admin"
            print("Bek tu etmin skrin")
            admin_screen(identity)
        else:
            if(choice != 0):
                print("Menu tidak terdaftar!")
